...
| socks-proxy | SOCKS4 / SOCKS5 | 10.99.0.20 | 1080 | — | — | Unauthenticated Dante proxy |
| http-proxy | HTTP proxy / CONNECT | 10.99.0.21 | 8888 | — | — | Unauthenticated tinyproxy |
...
The HTTP proxy's CONNECT allow-list covers the lab TCP backends used
by proxy integration tests, including Telnet `23`, FTP/FTPS control
and passive data ports, SMB `445`, POP3 `110`, IMAP `143`, Rsync
`873`, S3 `9000`, and Azurite `10000`.
